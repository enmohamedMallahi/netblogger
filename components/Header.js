...
const Header = ({ full, post }) => {
		...
		return (
			<div className='h-screen max-w-screen-2xl bg-green-100 px-4 md:px-8 mx-auto'>
				<header className='flex justify-between items-center border-b py-4 md:py-4 mb-8'>
					...
					<button
						type='button'
						className='inline-flex items-center lg:hidden bg-gray-200 hover:bg-gray-300 focus-visible:ring ring-green-300 text-gray-200 active:text-gray-700 text-sm md:text-base font-semibold rounded-lg gap-2 px-2.5 py-2'
					>
						<svg
	...
	if (post) {
		return (
			<div
				className='h-screen max-w-screen-2xl px-4 md:px-8 mx-auto'
				style={{
			...
			>
				<header className='flex  justify-between items-center border-b py-4 md:py-4 mb-8'>
					<Link
						href='/'
						className='inline-flex items-center text-black-800 text-xl md:text-2xl font-bold gap-2.5 text-white'
						aria-label='logo'
					>
						Satori Anime
					</Link>
				...
				<section className='flex flex-col items-center py-16 md:py-0'>
					<div className='max-w-xl flex flex-col items-center text-center pt-8 lg:pt-32 pb-16 lg:pb-48'>
						<h1 className='text-black-800 text-3xl sm:text-4xl md:text-5xl font-bold mb-4 text-white'>
							{post.title}
						</h1>
						<p className='text-gray-100 mb-4'>{post.subtitle}</p>
